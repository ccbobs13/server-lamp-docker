...
<body>
    ...
    $sql_ajout = "insert into etudiant values(null,:nom,
    ...
    if (isset($_POST['valider'])) {
        ...
        if (
            ...
            if ($rp->execute()) {
                ...
                //Si la requête s'est mal exécutée
    ...
    ?>
    <!-- Affichage du message de reussite ou d'echec de l'insertion -->
                ...
                <form method="POST" action="">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Creation d'un etudiant</h5>
    ...
    <div class="container" style="margin-top: 10;">
        <table class="table table-striped table-hover table-responsive caption-top">
            ...
            <tbody>
                ...
                $sql_part = "select * from etudiant";
                //Exécution
                $query_part = $pdo->query($sql_part);
                $count = $query_part->rowCount();
                if ($count== 0) {
                    echo "<tr><td colspan='7' class='text-center bg-danger' style='color: #fff;'>Aucun etudiant</td></tr>";
                } else {
                ...
                ?>
                            <tr>
                                ...
                                <td><?= $classe ?></td>
                                <td scope="col">
                                    <a role="button" class="btn btn-primary btn-sm" href="modifier.php?type=etudiant&id=<?= $id ?>">
                                        <span><i class="fa-solid fa-edit"></i></span>
                                        Modifier
                                    </a>
                                    <a id="supprimer" class="btn btn-danger btn-sm" onclick="return confirm('Voulez vous supprimer <?= $nom ?> ?\nOui ou Non?')" href="supprimer.php?type=etudiant&id=<?= $id ?>" role="button">
